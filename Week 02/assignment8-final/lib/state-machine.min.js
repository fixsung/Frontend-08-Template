/*
 * @Author: songyzh
 * @Date: 2021-01-05 10:50:19
 * @LastEditors: songyzh
 * @LastEditTime: 2021-01-05 10:50:20
 */
!(function (t, n) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = n())
    : "function" == typeof define && define.amd
    ? define("StateMachine", [], n)
    : "object" == typeof exports
    ? (exports.StateMachine = n())
    : (t.StateMachine = n());
})(this, function () {
  return (function (t) {
    function n(e) {
    ...
    function (t, n, i) {
      ...
      function e(t) {
        ...
        for (i = e[0].toLowerCase(), n = 1; n < e.length; n++)
          i =
            i + e[n].charAt(0).toUpperCase() + e[n].substring(1).toLowerCase();
        return i;
      }
    ...
    function (t, n, i) {
      ...
      s(e.prototype, {
        ...
        addTransition: function (t) {
          this.transitions.indexOf(t) < 0 &&
            (this.transitions.push(t), this.addTransitionLifecycleNames(t));
        },
        ...
        configureInitTransition: function (t) {
          return "string" == typeof t
            ? this.mapTransition(
                s({}, this.defaults.init, { to: t, active: !0 })
              )
            : "object" == typeof t
            ? this.mapTransition(s({}, this.defaults.init, t, { active: !0 }))
    ...
    function (t, n, i) {
      ...
      s(e.prototype, {
        init: function (t) {
          if (
            (s(this.context, this.config.data.apply(this.context, t)),
            o.hook(this, "init"),
        ...
        transit: function (t, n, i, e) {
          ...
          return i
            ? this.isPending()
              ? this.context.onPendingTransition(t, n, i)
              : (this.config.addState(i),
                this.beginTransit(),
                e.unshift({ transition: t, from: n, to: i, fsm: this.context }),
                this.observeEvents(
                  [
                    this.observersForEvent(s.onBefore.transition),
                    this.observersForEvent(s.onBefore[t]),
                    r ? this.observersForEvent(s.onLeave.state) : a,
                    r ? this.observersForEvent(s.onLeave[n]) : a,
                    this.observersForEvent(s.on.transition),
                    r ? ["doTransit", [this]] : a,
                    r ? this.observersForEvent(s.onEnter.state) : a,
                    r ? this.observersForEvent(s.onEnter[i]) : a,
                    r ? this.observersForEvent(s.on[i]) : a,
                    this.observersForEvent(s.onAfter.transition),
                    this.observersForEvent(s.onAfter[t]),
                    this.observersForEvent(s.on[t]),
                  ],
                  e
                ))
            : this.context.onInvalidTransition(t, n, i);
        },
        ...
        observeEvents: function (t, n, i, e) {
          ...
          if (
            ...
            return t.shift(), this.observeEvents(t, n, s, e);
          var f = r.shift(),
            c = f[s].apply(f, n);
          return c && "function" == typeof c.then
            ? c
                .then(this.observeEvents.bind(this, t, n, s))
                .catch(this.failTransit.bind(this))
            : !1 === c
            ? this.endTransit(!1)
            : this.observeEvents(t, n, s, c);
        },
    ...
    function (t, n, i) {
      ...
      (e.version = "3.0.1"),
        (e.factory = s),
        (e.apply = r),
        (e.defaults = { wildcard: "*", init: { name: "init", from: "none" } }),
        (t.exports = e);
    },
    function (t, n, i) {
      "use strict";
